        ...
        <div className="flex justify-start items-center text-base md:flex-row flex-col ">
          ...
          <div className="flex flex-col justify-center text-center md:items-center items-start lg:text-left basis-full md:mt-[30px] md:ml-[80px] max-w-[480px] order-1 md:order-2">
            ...
            <div className="w-full">
              <Link
                href=""
                className={`group flex items-center gap-[15px] py-[14px] px-4 border-2 opacity-80 rounded-full mt-[30px] lg:mt-[25px] xl:mt-10 w-fit hover:bg-[${theme?.colors?.primary?.[0]}] transition-all ease-in-out duration-200 hover:bg-[#6b9eff] hover:text-white hover:border-[#6b9eff] `}
              >
